...
C {devices/ipin.sym} 260 -230 0 0 {name=p1 lab=dum}
C {devices/iopin.sym} 260 -200 2 0 {name=p6 lab=vdd}
C {devices/iopin.sym} 260 -170 2 0 {name=p8 lab=vss}
...
C \{sky130_stdcells/tap_2.sym\}}
C {sar/sw/sw_top.sym} 160 -620 0 0 {name=xswt}
C {devices/lab_wire.sym} 810 -380 3 0 {name=l2 sig_type=std_logic lab=ctl[6]}
C {devices/lab_wire.sym} 1030 -380 3 0 {name=l3 sig_type=std_logic lab=ctl[5]}
C {devices/lab_wire.sym} 1250 -380 3 0 {name=l4 sig_type=std_logic lab=ctl[4]}
C {devices/lab_wire.sym} 1470 -380 3 0 {name=l5 sig_type=std_logic lab=ctl[3]}
C {devices/lab_wire.sym} 1690 -380 3 0 {name=l6 sig_type=std_logic lab=ctl[2]}
C {devices/lab_wire.sym} 1910 -380 3 0 {name=l7 sig_type=std_logic lab=ctl[1]}
C {devices/lab_wire.sym} 2130 -380 3 0 {name=l8 sig_type=std_logic lab=ctl[0]}
C {devices/lab_wire.sym} 2350 -380 3 0 {name=l9 sig_type=std_logic lab=dum}
C {sar/sw/sw_top.sym} 160 -550 0 0 {name=xswt1}
C {sar/sw/sw_top.sym} 160 -470 0 0 {name=xswt2}
C {sar/sw/sw_top.sym} 160 -380 0 0 {name=xswt3}
C {devices/lab_wire.sym} 200 -600 2 1 {name=l10 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 200 -520 2 1 {name=l11 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 200 -430 2 1 {name=l12 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 200 -560 0 0 {name=l13 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 200 -480 0 0 {name=l14 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 200 -390 0 0 {name=l15 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 210 -390 0 0 {name=l16 sig_type=std_logic lab=vss}
