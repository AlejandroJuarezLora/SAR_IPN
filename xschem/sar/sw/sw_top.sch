...
C {devices/lab_wire.sym} 200 -430 0 0 {name=l23 sig_type=std_logic lab=en_buf}
...
C {sky130_stdcells/inv_4.sym} 440 -40 0 0 {name=x1 VGND=vss VNB=vss VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ 
C \{devices/lab_wire.sym\}}
C {devices/lab_wire.sym} 490 -40 1 0 {name=l1 sig_type=std_logic lab=en_buf}
